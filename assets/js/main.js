...
(function ($) {
  ...
  if(autoTypeElements.length > 0){
      var typed = new Typed(".auto-type", {
          strings: ["Musicians", "Dancers", "Artists", "Emcees", "DJ", "Roaming Act", "Circus Act"],
          typeSpeed: 100,
          backSpeed: 30,
          loop: true,
          showCursor: false
...
const reviwsWrapper = new Swiper('.reviews', {
  breakpoints:{
      100:{
          slidesPerView:1.1,
          autoplay:{
  ...
  /** Override JS */
  var showBookingDetails = document.getElementById('show_booking_details');
  if(showBookingDetails){
    showBookingDetails.addEventListener('click',function(e){
      e.preventDefault();
      showBookingDetails.style.display = 'none';
      var bookingDetails = document.querySelector('.gt-booking-details');
